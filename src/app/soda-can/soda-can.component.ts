...
@Component({
  selector: 'app-soda-can',
  templateUrl: './soda-can.component.html',
  styleUrls: ['./soda-can.component.scss']
})
export class SodaCanComponent implements OnInit {
  @Input() 
...
cup$ = this.gltfLoaderService.load('assets/soda_can/scene.gltf');
...
cupLoaded(object: Object3D) {
  ...
  this.cupMaterial = <MeshStandardMaterial>(<Mesh>object.getObjectByName('pCylinder10_lambert1_0')).material;
